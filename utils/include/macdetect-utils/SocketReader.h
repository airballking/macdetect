...
namespace macdetect {
  ...
  public:
    ...
    int read(unsigned char* ucBuffer, unsigned int unLength, int nFlags);
    virtual int read(unsigned char* ucBuffer, unsigned int unLength, int nFlags, std::string& strIP);
